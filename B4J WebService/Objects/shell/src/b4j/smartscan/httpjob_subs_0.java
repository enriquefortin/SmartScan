...
try {
		Debug.PushSubsStack("AddScheme (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,306);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,252);
...
Debug.JustUpdateDeviceLine();
_link = __ref.runClassMethod (b4j.smartscan.httpjob.class, "_addscheme" /*RemoteObject*/ ,(Object)(_link));Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93604485",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,263);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4j.smartscan.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93670021",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 269;BA.debugLine="req.InitializeDelete(escapeLink(InvalidURL, Para";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4j.smartscan.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_invalidurl" /*RemoteObject*/ )),(Object)(_parameters))));
 };
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,210);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,226);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4j.smartscan.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93473413",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 232;BA.debugLine="req.InitializeGet(escapeLink(InvalidURL, Paramet";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4j.smartscan.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_invalidurl" /*RemoteObject*/ )),(Object)(_parameters))));
 };
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,237);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,301);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,282);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.smartscan.httpjob.class, "_getstring2" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,287);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,170);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,88);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93080204",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,83);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.smartscan.httpjob.class, "_patchbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,181);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93342344",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.smartscan.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,124);
...
RemoteObject _fd = RemoteObject.declareNull("b4j.smartscan.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (b4j.smartscan.httpjob.class, "_multipartstartsection" /*RemoteObject*/ ,(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.smartscan.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,49);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.smartscan.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,66);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.smartscan.httpjob.class, "_putbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,275);
