...
public class cr extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("b4j.smartscan", "b4j.smartscan.cr", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.smartscan.cr.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("24259841","colococero desde js",0);
...
__c.LogImpl("23735553","Device message: "+BA.ObjectToString(_params.Get((Object)("message"))),0);
...
public ResumableSub_Enviar_sessionid(b4j.smartscan.cr parent,anywheresoftware.b4a.objects.collections.Map _param) {
this.parent = parent;
this._param = _param;
}
b4j.smartscan.cr parent;
...
parent.__c.LogImpl("24063234","devulvo",0);
...
parent.__c.LogImpl("24063247",_j._getstring /*String*/ (),0);
 //BA.debugLineNum = 201;BA.debugLine="Log(\"mensaje enviado\")";
parent.__c.LogImpl("24063248","mensaje enviado",0);
 if (true) break;
...
public ResumableSub_enviarAI(b4j.smartscan.cr parent,String _message) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 408;BA.debugLine="Dim strAPIurl As String =\"https://generativelangu";
_strapiurl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAAlU6UEaSo0NcGFZWC_q2uZOh8uBuQSt0";
 //BA.debugLineNum = 409;BA.debugLine="Log(strAPIurl)";
parent.__c.LogImpl("24915202",_strapiurl,0);
 //BA.debugLineNum = 412;BA.debugLine="Dim partsMap As Map";
_partsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 413;BA.debugLine="partsMap.Initialize";
_partsmap.Initialize();
 //BA.debugLineNum = 414;BA.debugLine="partsMap.Put(\"text\", $\" del siguiente bloque de t";
_partsmap.Put((Object)("text"),(Object)((" del siguiente bloque de texto necesito que me identifiques y ordenes los siguientes valores MOTOR, PLACA, AÑO, MARCA, CHASIS algunos ejemplos\n"+"	 de motor son los siguientes (45386047, YD25776714P, MGC20597, CE7AN29R9052) algunos ejemplos de numeros de placa son los siguientes (TEA7853, HED8025, HDA4779)\n"+"	  el año siempre toma el que no encuetres bajo el texto año sino el siguiente la marca pueden ser dos ejemplo TOYOTA \n"+"	   toma en cuenta que el numero del motor siempre tendra menos o igual tamaño de caracteres que el numero del chasis favor limita la respuesta unicamente a los datos\n"+"	    en una lista ordenada  en el formato Motor: CE7AN29R9052\\nPlaca: XXX1234\\nAño: 2022\\nMarca: TOYOTA\\nChasis: MD637AE74N2AB1025 \\n el parametro el valor o numero \n"+"		luego en el siguiente espacio el numero de placa y asi con los datos solicitados recuerda unicamente Motor,Placa,Año,Marca y Chasis no mas datos. agunos ejmeplos \n"+"		de chasis son los siguientes (1FV6HLAA7VL714763, 3N6CD33B2ZK463860, JTEBR3FJ60K277588): "+parent.__c.SmartStringFormatter("",(Object)(_message))+" ")));
 //BA.debugLineNum = 423;BA.debugLine="Dim partsList As List";
_partslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 424;BA.debugLine="partsList.Initialize";
_partslist.Initialize();
 //BA.debugLineNum = 425;BA.debugLine="partsList.Add(partsMap)";
_partslist.Add((Object)(_partsmap.getObject()));
 //BA.debugLineNum = 428;BA.debugLine="Dim contentsMap As Map";
_contentsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 429;BA.debugLine="contentsMap.Initialize";
_contentsmap.Initialize();
 //BA.debugLineNum = 430;BA.debugLine="contentsMap.Put(\"parts\", partsList)";
_contentsmap.Put((Object)("parts"),(Object)(_partslist.getObject()));
 //BA.debugLineNum = 433;BA.debugLine="Dim contentsList As List";
_contentslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 434;BA.debugLine="contentsList.Initialize";
_contentslist.Initialize();
 //BA.debugLineNum = 435;BA.debugLine="contentsList.Add(contentsMap)";
_contentslist.Add((Object)(_contentsmap.getObject()));
 //BA.debugLineNum = 438;BA.debugLine="Dim finalMap As Map";
_finalmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 439;BA.debugLine="finalMap.Initialize";
_finalmap.Initialize();
 //BA.debugLineNum = 440;BA.debugLine="finalMap.Put(\"contents\", contentsList)";
_finalmap.Put((Object)("contents"),(Object)(_contentslist.getObject()));
 //BA.debugLineNum = 443;BA.debugLine="Dim JSONGenerator As JSONGenerator";
_jsongenerator = new anywheresoftware.b4j.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 444;BA.debugLine="JSONGenerator.Initialize(finalMap)";
_jsongenerator.Initialize(_finalmap);
 //BA.debugLineNum = 446;BA.debugLine="Log(JSONGenerator.ToString)";
parent.__c.LogImpl("24915239",_jsongenerator.ToString(),0);
 //BA.debugLineNum = 448;BA.debugLine="Dim strPayload As String = JSONGenerator.ToString";
_strpayload = _jsongenerator.ToString();
 //BA.debugLineNum = 450;BA.debugLine="Dim j As HttpJob";
_j = new b4j.smartscan.httpjob();
 //BA.debugLineNum = 451;BA.debugLine="j.Initialize(\"\", Me)";
_j._initialize /*String*/ (ba,"",parent);
 //BA.debugLineNum = 452;BA.debugLine="J.PostString(strAPIurl,strPayload)";
_j._poststring /*String*/ (_strapiurl,_strpayload);
 //BA.debugLineNum = 453;BA.debugLine="J.GetRequest.SetContentType(\"application/json\")";
_j._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 455;BA.debugLine="Wait For (J) JobDone(j As HttpJob)";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_j));
this.state = 19;
return;
case 19:
...
_j = (b4j.smartscan.httpjob) result[0];
;
 //BA.debugLineNum = 456;BA.debugLine="If J.Success Then";
if (true) break;
...
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 459;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 460;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 461;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 462;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 463;BA.debugLine="Dim candidates As List";
_candidates = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 464;BA.debugLine="candidates.Initialize";
_candidates.Initialize();
 //BA.debugLineNum = 465;BA.debugLine="candidates= jRoot.Get(\"candidates\")";
_candidates = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jroot.Get((Object)("candidates"))));
 //BA.debugLineNum = 466;BA.debugLine="Dim colcandidates As Map";
_colcandidates = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 467;BA.debugLine="colcandidates.Initialize";
_colcandidates.Initialize();
 //BA.debugLineNum = 468;BA.debugLine="For Each colcandidates As Map In candidates";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 469;BA.debugLine="Dim finishReason As String = colcandidates.Get(";
_finishreason = BA.ObjectToString(_colcandidates.Get((Object)("finishReason")));
 //BA.debugLineNum = 470;BA.debugLine="Dim index As Int = colcandidates.Get(\"index\")";
_index = (int)(BA.ObjectToNumber(_colcandidates.Get((Object)("index"))));
 //BA.debugLineNum = 471;BA.debugLine="Dim safetyRatings As List";
_safetyratings = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 472;BA.debugLine="safetyRatings.Initialize";
_safetyratings.Initialize();
 //BA.debugLineNum = 473;BA.debugLine="safetyRatings = colcandidates.Get(\"safetyRating";
_safetyratings = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_colcandidates.Get((Object)("safetyRatings"))));
 //BA.debugLineNum = 474;BA.debugLine="Dim colsafetyRatings As Map";
_colsafetyratings = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 475;BA.debugLine="colsafetyRatings.Initialize";
_colsafetyratings.Initialize();
 //BA.debugLineNum = 476;BA.debugLine="For Each colsafetyRatings As Map In safetyRatin";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 477;BA.debugLine="Dim probability As String = colsafetyRatings.G";
_probability = BA.ObjectToString(_colsafetyratings.Get((Object)("probability")));
 //BA.debugLineNum = 478;BA.debugLine="Dim category As String = colsafetyRatings.Get(";
...
this.state = 11;
;
 //BA.debugLineNum = 480;BA.debugLine="Dim content As Map";
_content = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 481;BA.debugLine="content.Initialize";
_content.Initialize();
 //BA.debugLineNum = 482;BA.debugLine="content = colcandidates.Get(\"content\")";
_content = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_colcandidates.Get((Object)("content"))));
 //BA.debugLineNum = 483;BA.debugLine="Dim role As String = content.Get(\"role\")";
_role = BA.ObjectToString(_content.Get((Object)("role")));
 //BA.debugLineNum = 484;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
...
_parts = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_content.Get((Object)("parts"))));
 //BA.debugLineNum = 486;BA.debugLine="partes=parts";
parent._partes = _parts;
 //BA.debugLineNum = 487;BA.debugLine="Dim colparts As Map";
_colparts = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 488;BA.debugLine="colparts.Initialize";
_colparts.Initialize();
 //BA.debugLineNum = 489;BA.debugLine="For Each colparts As Map In parts";
if (true) break;
...
//C
this.state = 25;
 //BA.debugLineNum = 490;BA.debugLine="Dim text As String = colparts.Get(\"text\")";
...
this.state = 18;
;
 //BA.debugLineNum = 495;BA.debugLine="Dim usageMetadata As Map";
_usagemetadata = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 496;BA.debugLine="usageMetadata.Initialize";
_usagemetadata.Initialize();
 //BA.debugLineNum = 497;BA.debugLine="usageMetadata = jRoot.Get(\"usageMetadata\")";
_usagemetadata = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("usageMetadata"))));
 //BA.debugLineNum = 498;BA.debugLine="Dim candidatesTokenCount As Int = usageMetadata.";
_candidatestokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("candidatesTokenCount"))));
 //BA.debugLineNum = 499;BA.debugLine="Dim totalTokenCount As Int = usageMetadata.Get(\"";
_totaltokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("totalTokenCount"))));
 //BA.debugLineNum = 500;BA.debugLine="Dim promptTokenCount As Int = usageMetadata.Get(";
...
//C
this.state = 18;
 //BA.debugLineNum = 506;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 507;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 508;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 509;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 510;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 511;BA.debugLine="Dim error As Map";
_error = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 512;BA.debugLine="error.Initialize";
_error.Initialize();
 //BA.debugLineNum = 513;BA.debugLine="error = jRoot.Get(\"error\")";
_error = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("error"))));
 //BA.debugLineNum = 514;BA.debugLine="Dim code As Int = error.Get(\"code\")";
_code = (int)(BA.ObjectToNumber(_error.Get((Object)("code"))));
 //BA.debugLineNum = 515;BA.debugLine="Dim message As String = error.Get(\"message\")";
_message = BA.ObjectToString(_error.Get((Object)("message")));
 //BA.debugLineNum = 516;BA.debugLine="Dim status As String = error.Get(\"status\")";
parent._status = BA.ObjectToString(_error.Get((Object)("status")));
 //BA.debugLineNum = 517;BA.debugLine="Log(message)";
parent.__c.LogImpl("24915310",_message,0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 520;BA.debugLine="j.Release";
_j._release /*String*/ ();
 //BA.debugLineNum = 522;BA.debugLine="Log(partes)";
parent.__c.LogImpl("24915315",BA.ObjectToString(parent._partes),0);
 //BA.debugLineNum = 525;BA.debugLine="ProcessList(partes)";
...
public ResumableSub_enviarAINombre(b4j.smartscan.cr parent,String _message) {
this.parent = parent;
this._message = _message;
}
b4j.smartscan.cr parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 533;BA.debugLine="Dim strAPIurl As String =\"https://generativelangu";
_strapiurl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAAlU6UEaSo0NcGFZWC_q2uZOh8uBuQSt0";
 //BA.debugLineNum = 534;BA.debugLine="Log(strAPIurl)";
parent.__c.LogImpl("24980738",_strapiurl,0);
 //BA.debugLineNum = 537;BA.debugLine="Dim partsMap As Map";
_partsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 538;BA.debugLine="partsMap.Initialize";
_partsmap.Initialize();
 //BA.debugLineNum = 539;BA.debugLine="partsMap.Put(\"text\", $\" del siguiente bloque de t";
_partsmap.Put((Object)("text"),(Object)((" del siguiente bloque de texto necesito que me identifiques y ordenes los siguientes valores Nombre y Numero de identificacion  el nombre puedes encontrarlo\n"+"	como uno o dos nombre como ejemplo JUAN MANUEL por favor concatena con el apellido que puedes encontrarlo como ejemplo como LOPEZ GONZALEZ limita la respuesta unicamente a los datos\n"+"	en una lista ordenada  en el formato Nombre: JUAN MANUEL LOPEZ GONZALEZ\\Identidad: 0801199012345\\n\n"+"	recuerda unicamente Nombre concatenado con el apellido y Numero de identidad no mas datos. si la cadena contiene N°: toma ese numero como identidad: "+parent.__c.SmartStringFormatter("",(Object)(_message))+" ")));
 //BA.debugLineNum = 545;BA.debugLine="Dim partsList As List";
_partslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 546;BA.debugLine="partsList.Initialize";
_partslist.Initialize();
 //BA.debugLineNum = 547;BA.debugLine="partsList.Add(partsMap)";
_partslist.Add((Object)(_partsmap.getObject()));
 //BA.debugLineNum = 550;BA.debugLine="Dim contentsMap As Map";
_contentsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 551;BA.debugLine="contentsMap.Initialize";
_contentsmap.Initialize();
 //BA.debugLineNum = 552;BA.debugLine="contentsMap.Put(\"parts\", partsList)";
_contentsmap.Put((Object)("parts"),(Object)(_partslist.getObject()));
 //BA.debugLineNum = 555;BA.debugLine="Dim contentsList As List";
_contentslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 556;BA.debugLine="contentsList.Initialize";
_contentslist.Initialize();
 //BA.debugLineNum = 557;BA.debugLine="contentsList.Add(contentsMap)";
_contentslist.Add((Object)(_contentsmap.getObject()));
 //BA.debugLineNum = 560;BA.debugLine="Dim finalMap As Map";
_finalmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 561;BA.debugLine="finalMap.Initialize";
_finalmap.Initialize();
 //BA.debugLineNum = 562;BA.debugLine="finalMap.Put(\"contents\", contentsList)";
_finalmap.Put((Object)("contents"),(Object)(_contentslist.getObject()));
 //BA.debugLineNum = 565;BA.debugLine="Dim JSONGenerator As JSONGenerator";
_jsongenerator = new anywheresoftware.b4j.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 566;BA.debugLine="JSONGenerator.Initialize(finalMap)";
_jsongenerator.Initialize(_finalmap);
 //BA.debugLineNum = 568;BA.debugLine="Log(JSONGenerator.ToString)";
parent.__c.LogImpl("24980772",_jsongenerator.ToString(),0);
 //BA.debugLineNum = 570;BA.debugLine="Dim strPayload As String = JSONGenerator.ToString";
_strpayload = _jsongenerator.ToString();
 //BA.debugLineNum = 572;BA.debugLine="Dim j As HttpJob";
_j = new b4j.smartscan.httpjob();
 //BA.debugLineNum = 573;BA.debugLine="j.Initialize(\"\", Me)";
_j._initialize /*String*/ (ba,"",parent);
 //BA.debugLineNum = 574;BA.debugLine="J.PostString(strAPIurl,strPayload)";
_j._poststring /*String*/ (_strapiurl,_strpayload);
 //BA.debugLineNum = 575;BA.debugLine="J.GetRequest.SetContentType(\"application/json\")";
_j._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 577;BA.debugLine="Wait For (J) JobDone(j As HttpJob)";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_j));
this.state = 19;
return;
case 19:
...
_j = (b4j.smartscan.httpjob) result[0];
;
 //BA.debugLineNum = 578;BA.debugLine="If J.Success Then";
if (true) break;
...
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 581;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 582;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 583;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 584;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 585;BA.debugLine="Dim candidates As List";
_candidates = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 586;BA.debugLine="candidates.Initialize";
_candidates.Initialize();
 //BA.debugLineNum = 587;BA.debugLine="candidates= jRoot.Get(\"candidates\")";
_candidates = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jroot.Get((Object)("candidates"))));
 //BA.debugLineNum = 588;BA.debugLine="Dim colcandidates As Map";
_colcandidates = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 589;BA.debugLine="colcandidates.Initialize";
_colcandidates.Initialize();
 //BA.debugLineNum = 590;BA.debugLine="For Each colcandidates As Map In candidates";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 591;BA.debugLine="Dim finishReason As String = colcandidates.Get(";
_finishreason = BA.ObjectToString(_colcandidates.Get((Object)("finishReason")));
 //BA.debugLineNum = 592;BA.debugLine="Dim index As Int = colcandidates.Get(\"index\")";
_index = (int)(BA.ObjectToNumber(_colcandidates.Get((Object)("index"))));
 //BA.debugLineNum = 593;BA.debugLine="Dim safetyRatings As List";
_safetyratings = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 594;BA.debugLine="safetyRatings.Initialize";
_safetyratings.Initialize();
 //BA.debugLineNum = 595;BA.debugLine="safetyRatings = colcandidates.Get(\"safetyRating";
_safetyratings = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_colcandidates.Get((Object)("safetyRatings"))));
 //BA.debugLineNum = 596;BA.debugLine="Dim colsafetyRatings As Map";
_colsafetyratings = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 597;BA.debugLine="colsafetyRatings.Initialize";
_colsafetyratings.Initialize();
 //BA.debugLineNum = 598;BA.debugLine="For Each colsafetyRatings As Map In safetyRatin";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 599;BA.debugLine="Dim probability As String = colsafetyRatings.G";
_probability = BA.ObjectToString(_colsafetyratings.Get((Object)("probability")));
 //BA.debugLineNum = 600;BA.debugLine="Dim category As String = colsafetyRatings.Get(";
_category = BA.ObjectToString(_colsafetyratings.Get((Object)("category")));
 if (true) break;
if (true) break;
...
this.state = 11;
;
 //BA.debugLineNum = 602;BA.debugLine="Dim content As Map";
_content = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 603;BA.debugLine="content.Initialize";
_content.Initialize();
 //BA.debugLineNum = 604;BA.debugLine="content = colcandidates.Get(\"content\")";
_content = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_colcandidates.Get((Object)("content"))));
 //BA.debugLineNum = 605;BA.debugLine="Dim role As String = content.Get(\"role\")";
_role = BA.ObjectToString(_content.Get((Object)("role")));
 //BA.debugLineNum = 606;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
_parts = new anywheresoftware.b4a.objects.collections.List();
_parts = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_content.Get((Object)("parts"))));
 //BA.debugLineNum = 608;BA.debugLine="partes=parts";
parent._partes = _parts;
 //BA.debugLineNum = 609;BA.debugLine="Dim colparts As Map";
_colparts = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 610;BA.debugLine="colparts.Initialize";
_colparts.Initialize();
 //BA.debugLineNum = 611;BA.debugLine="For Each colparts As Map In parts";
if (true) break;
...
//C
this.state = 25;
 //BA.debugLineNum = 612;BA.debugLine="Dim text As String = colparts.Get(\"text\")";
_text = BA.ObjectToString(_colparts.Get((Object)("text")));
 if (true) break;
if (true) break;
...
this.state = 18;
;
 //BA.debugLineNum = 617;BA.debugLine="Dim usageMetadata As Map";
_usagemetadata = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 618;BA.debugLine="usageMetadata.Initialize";
_usagemetadata.Initialize();
 //BA.debugLineNum = 619;BA.debugLine="usageMetadata = jRoot.Get(\"usageMetadata\")";
_usagemetadata = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("usageMetadata"))));
 //BA.debugLineNum = 620;BA.debugLine="Dim candidatesTokenCount As Int = usageMetadata.";
_candidatestokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("candidatesTokenCount"))));
 //BA.debugLineNum = 621;BA.debugLine="Dim totalTokenCount As Int = usageMetadata.Get(\"";
_totaltokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("totalTokenCount"))));
 //BA.debugLineNum = 622;BA.debugLine="Dim promptTokenCount As Int = usageMetadata.Get(";
_prompttokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("promptTokenCount"))));
 if (true) break;
...
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 629;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 630;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 631;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 632;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 633;BA.debugLine="Dim error As Map";
_error = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 634;BA.debugLine="error.Initialize";
_error.Initialize();
 //BA.debugLineNum = 635;BA.debugLine="error = jRoot.Get(\"error\")";
_error = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("error"))));
 //BA.debugLineNum = 636;BA.debugLine="Dim code As Int = error.Get(\"code\")";
_code = (int)(BA.ObjectToNumber(_error.Get((Object)("code"))));
 //BA.debugLineNum = 637;BA.debugLine="Dim message As String = error.Get(\"message\")";
_message = BA.ObjectToString(_error.Get((Object)("message")));
 //BA.debugLineNum = 638;BA.debugLine="Dim status As String = error.Get(\"status\")";
parent._status = BA.ObjectToString(_error.Get((Object)("status")));
 //BA.debugLineNum = 639;BA.debugLine="Log(message)";
parent.__c.LogImpl("24980843",_message,0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 642;BA.debugLine="j.Release";
_j._release /*String*/ ();
 //BA.debugLineNum = 644;BA.debugLine="Log(partes)";
parent.__c.LogImpl("24980848",BA.ObjectToString(parent._partes),0);
 //BA.debugLineNum = 646;BA.debugLine="ProcessListNombre(partes)";
...
_mysql.ExecNonQuery2("insert into InfoDB values (?,?,?,?,?,?,?,?,?,?) ",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{__c.Null,_txtnombre.GetVal().getValue(),_txtidentidad.GetVal().getValue(),__c.Null,_txtmotor.GetVal().getValue(),_txtplaca.GetVal().getValue(),_txtanio.GetVal().getValue(),_txtcolor.GetVal().getValue(),_txtchasis.GetVal().getValue(),(Object)("CR")}));
...
_main._sql1 /*anywheresoftware.b4j.objects.SQL*/ .InitializeSQLite(__c.File.getDirApp()+"/DB","InfoDBCR.db",__c.False);
...
__c.LogImpl("24390914",BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagecr"))),0);
 //BA.debugLineNum = 279;BA.debugLine="Log(txtiddelmovil.GetVal.Value)";
__c.LogImpl("24390915",BA.ObjectToString(_txtiddelmovil.GetVal().getValue()),0);
 //BA.debugLineNum = 280;BA.debugLine="txtmensaje.SetHtml(\"\")";
_txtmensaje.SetHtml("");
 //BA.debugLineNum = 281;BA.debugLine="Log(\"CLICK\")";
__c.LogImpl("24390917","CLICK",0);
 //BA.debugLineNum = 283;BA.debugLine="txtmensaje.SetText(Main.msj.Get(txtiddelmovil.Get";
_txtmensaje.SetText(BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagecr"))));
 //BA.debugLineNum = 285;BA.debugLine="Dim message As String = Main.msj.Get(txtiddelmovi";
_message = BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagecr")));
 //BA.debugLineNum = 288;BA.debugLine="If message.Contains(\"Placa\") Or message.Contains(";
if (_message.contains("Placa") || _message.contains("Chasis") || _message.contains("Motor") || _message.contains("VIN")) { 
 //BA.debugLineNum = 289;BA.debugLine="enviarAI(message)";
_enviarai(_message);
 };
 //BA.debugLineNum = 292;BA.debugLine="If message.Contains(\"Nombre\") Or message.Contains";
if (_message.contains("Nombre") || _message.contains("Apellido") || _message.contains("Identidad") || _message.contains("Nacimiento")) { 
...
__c.LogImpl("23801089","click al boton leertesseract",0);
...
__c.LogImpl("23801098",BA.ObjectToString(_langlist),0);
 //BA.debugLineNum = 82;BA.debugLine="Log(langmap)";
__c.LogImpl("23801099",BA.ObjectToString(_langmap),0);
 //BA.debugLineNum = 83;BA.debugLine="Log(langmap.Get(\"Español\"))";
__c.LogImpl("23801100",BA.ObjectToString(_langmap.Get((Object)("Español"))),0);
...
__c.LogImpl("24653057",_text,0);
 //BA.debugLineNum = 355;BA.debugLine="Log(ProcessingTime & \" ms\")";
__c.LogImpl("24653058",BA.NumberToString(_processingtime)+" ms",0);
...
__c.LogImpl("24718593",BA.ObjectToString(_overlay),0);
...
__c.LogImpl("23866636",_main._nombrearchivo /*String*/ ,0);
...
__c.LogImpl("23866653",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
...
_anio = _extractvalue(_text,"Año:","Marca:");
 //BA.debugLineNum = 306;BA.debugLine="Dim color As String = ExtractValue(text, \"Marca:";
_color = _extractvalue(_text,"Marca:","Chasis:");
...
String _nombre = "";
String _identidad = "";
 //BA.debugLineNum = 651;BA.debugLine="Sub ProcessListNombre(inputList As List)";
 //BA.debugLineNum = 652;BA.debugLine="For Each item As Map In inputList";
_item = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group1 = _inputlist;
final int groupLen1 = group1.getSize()
...
for (; index1 < groupLen1;index1++){
_item = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group1.Get(index1)));
 //BA.debugLineNum = 653;BA.debugLine="Dim text As String = item.Get(\"text\")";
_text = BA.ObjectToString(_item.Get((Object)("text")));
 //BA.debugLineNum = 656;BA.debugLine="Dim nombre As String = ExtractValue(text, \"Nombr";
_nombre = _extractvalue(_text,"Nombre:","\\Identidad:");
 //BA.debugLineNum = 657;BA.debugLine="Dim identidad As String = ExtractValue(text, \"Id";
_identidad = _extractvalue(_text,"Identidad:","\\n");
 //BA.debugLineNum = 659;BA.debugLine="Log(nombre)";
__c.LogImpl("25046280",_nombre,0);
 //BA.debugLineNum = 661;BA.debugLine="txtnombre.SetVal(nombre)";
_txtnombre.SetVal((Object)(_nombre));
 //BA.debugLineNum = 662;BA.debugLine="txtidentidad.SetVal(identidad)";
_txtidentidad.SetVal((Object)(_identidad));
 }
};
 //BA.debugLineNum = 665;BA.debugLine="ws.Eval(\"validarCampos()\",Null)";
_ws.Eval("validarCampos()",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
...
__c.LogImpl("23932168","iniciado",0);
 }else {
...
__c.LogImpl("23932171",__c.File.Combine(__c.File.Combine(__c.File.getDirApp(),"tesseract-ocr"),"tesseract"),0);
 };
...
__c.LogImpl("24849666","Success",0);
 //BA.debugLineNum = 378;BA.debugLine="Log(StdOut)";
__c.LogImpl("24849667",_stdout,0);
...
__c.LogImpl("24849672",_message,0);
 //BA.debugLineNum = 387;BA.debugLine="If message.Contains(\"Placa\") Or message.Contains(";
if (_message.contains("Placa") || _message.contains("Chasis") || _message.contains("Motor") || _message.contains("VIN")) { 
 //BA.debugLineNum = 388;BA.debugLine="enviarAI(message)";
_enviarai(_message);
 };
 //BA.debugLineNum = 391;BA.debugLine="If message.Contains(\"Nombre\") Or message.Contains";
if (_message.contains("Nombre") || _message.contains("Apellido") || _message.contains("Identidad") || _message.contains("Nacimiento")) { 
 //BA.debugLineNum = 392;BA.debugLine="enviarAINombre(message)";
_enviarainombre(_message);
 };
 }else {
 //BA.debugLineNum = 398;BA.debugLine="Log(ExitCode)";
__c.LogImpl("24849687",BA.NumberToString(_exitcode),0);
 //BA.debugLineNum = 399;BA.debugLine="Log(\"Error: \" & StdErr)";
__c.LogImpl("24849688","Error: "+_stderr,0);
 //BA.debugLineNum = 400;BA.debugLine="ws.Alert(\"fallo de reconocimiento\")";
...
__c.LogImpl("23604489",_ws.getSession().getId(),0);
...
_ws.Eval(("validarPais(\""+__c.SmartStringFormatter("",_ws.getSession().GetAttribute("Pais"))+"\");"),(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 42;BA.debugLine="Log(ws.Session.GetAttribute(\"Pais\"))";
__c.LogImpl("23604498",BA.ObjectToString(_ws.getSession().GetAttribute("Pais")),0);
...
__c.LogImpl("24128771","disconnected",0);
