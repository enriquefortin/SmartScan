...
public class sv extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("b4j.smartscan", "b4j.smartscan.sv", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.smartscan.sv.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("2983041","colococero desde js",0);
...
__c.LogImpl("2458753","Device message: "+BA.ObjectToString(_params.Get((Object)("message"))),0);
...
public ResumableSub_Enviar_sessionid(b4j.smartscan.sv parent,anywheresoftware.b4a.objects.collections.Map _param) {
this.parent = parent;
this._param = _param;
}
b4j.smartscan.sv parent;
...
parent.__c.LogImpl("2786434","devulvo",0);
...
parent.__c.LogImpl("2786447",_j._getstring /*String*/ (),0);
 //BA.debugLineNum = 200;BA.debugLine="Log(\"mensaje enviado\")";
parent.__c.LogImpl("2786448","mensaje enviado",0);
 if (true) break;
...
public ResumableSub_enviarAI(b4j.smartscan.sv parent,String _message) {
this.parent = parent;
...
parent.__c.LogImpl("21638402",_strapiurl,0);
...
_partsmap.Put((Object)("text"),(Object)((" del siguiente bloque de texto necesito que me identifiques y ordenes los siguientes valores MOTOR, VIN, AÑO, COLOR, CHASIS algunos ejemplos\n"+"	 de motor son los siguientes (45386047, YD25776714P, MGC20597, CE7AN29R9052) algunos ejemplos  el año siempre toma el que no encuetres bajo el texto año sino el siguiente el color pueden ser dos ejemplo AZUL-BLANCO o tambien puede ser solo uno ejemplo AZUL\n"+"	   toma en cuenta que el numero del motor siempre tendra menos o igual tamaño de caracteres que el numero del chasis favor limita la respuesta unicamente a los datos\n"+"	    en una lista ordenada  en el formato Motor:CE7AN29R9052\\n VIN:XXXXXXXXXXXXXXXXXX\\n Año: 2022\\n Color: AZUL-BLANCO\\n Chasis: MD637AE74N2AB1025\\n el parametro el valor o numero \n"+"		luego en el siguiente espacio el numero de VIN y asi con los datos solicitados recuerda unicamente Motor,Vin,Año,Color y Chasis no mas datos. agunos ejmeplos \n"+"		de chasis son los siguientes (1FV6HLAA7VL714763, 3N6CD33B2ZK463860, JTEBR3FJ60K277588): "+parent.__c.SmartStringFormatter("",(Object)(_message))+" ")));
 //BA.debugLineNum = 418;BA.debugLine="Dim partsList As List";
_partslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 419;BA.debugLine="partsList.Initialize";
_partslist.Initialize();
 //BA.debugLineNum = 420;BA.debugLine="partsList.Add(partsMap)";
_partslist.Add((Object)(_partsmap.getObject()));
 //BA.debugLineNum = 423;BA.debugLine="Dim contentsMap As Map";
_contentsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 424;BA.debugLine="contentsMap.Initialize";
_contentsmap.Initialize();
 //BA.debugLineNum = 425;BA.debugLine="contentsMap.Put(\"parts\", partsList)";
_contentsmap.Put((Object)("parts"),(Object)(_partslist.getObject()));
 //BA.debugLineNum = 428;BA.debugLine="Dim contentsList As List";
_contentslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 429;BA.debugLine="contentsList.Initialize";
_contentslist.Initialize();
 //BA.debugLineNum = 430;BA.debugLine="contentsList.Add(contentsMap)";
_contentslist.Add((Object)(_contentsmap.getObject()));
 //BA.debugLineNum = 433;BA.debugLine="Dim finalMap As Map";
_finalmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 434;BA.debugLine="finalMap.Initialize";
_finalmap.Initialize();
 //BA.debugLineNum = 435;BA.debugLine="finalMap.Put(\"contents\", contentsList)";
_finalmap.Put((Object)("contents"),(Object)(_contentslist.getObject()));
 //BA.debugLineNum = 438;BA.debugLine="Dim JSONGenerator As JSONGenerator";
_jsongenerator = new anywheresoftware.b4j.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 439;BA.debugLine="JSONGenerator.Initialize(finalMap)";
_jsongenerator.Initialize(_finalmap);
 //BA.debugLineNum = 441;BA.debugLine="Log(JSONGenerator.ToString)";
parent.__c.LogImpl("21638438",_jsongenerator.ToString(),0);
 //BA.debugLineNum = 443;BA.debugLine="Dim strPayload As String = JSONGenerator.ToString";
_strpayload = _jsongenerator.ToString();
 //BA.debugLineNum = 445;BA.debugLine="Dim j As HttpJob";
_j = new b4j.smartscan.httpjob();
 //BA.debugLineNum = 446;BA.debugLine="j.Initialize(\"\", Me)";
_j._initialize /*String*/ (ba,"",parent);
 //BA.debugLineNum = 447;BA.debugLine="J.PostString(strAPIurl,strPayload)";
_j._poststring /*String*/ (_strapiurl,_strpayload);
 //BA.debugLineNum = 448;BA.debugLine="J.GetRequest.SetContentType(\"application/json\")";
_j._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 450;BA.debugLine="Wait For (J) JobDone(j As HttpJob)";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_j));
this.state = 19;
return;
case 19:
...
_j = (b4j.smartscan.httpjob) result[0];
;
 //BA.debugLineNum = 451;BA.debugLine="If J.Success Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 453;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 454;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 455;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 456;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 457;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 458;BA.debugLine="Dim candidates As List";
_candidates = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 459;BA.debugLine="candidates.Initialize";
_candidates.Initialize();
 //BA.debugLineNum = 460;BA.debugLine="candidates= jRoot.Get(\"candidates\")";
_candidates = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jroot.Get((Object)("candidates"))));
 //BA.debugLineNum = 461;BA.debugLine="Dim colcandidates As Map";
_colcandidates = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 462;BA.debugLine="colcandidates.Initialize";
_colcandidates.Initialize();
 //BA.debugLineNum = 463;BA.debugLine="For Each colcandidates As Map In candidates";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 464;BA.debugLine="Dim finishReason As String = colcandidates.Get(";
_finishreason = BA.ObjectToString(_colcandidates.Get((Object)("finishReason")));
 //BA.debugLineNum = 465;BA.debugLine="Dim index As Int = colcandidates.Get(\"index\")";
_index = (int)(BA.ObjectToNumber(_colcandidates.Get((Object)("index"))));
 //BA.debugLineNum = 466;BA.debugLine="Dim safetyRatings As List";
_safetyratings = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 467;BA.debugLine="safetyRatings.Initialize";
_safetyratings.Initialize();
 //BA.debugLineNum = 468;BA.debugLine="safetyRatings = colcandidates.Get(\"safetyRating";
_safetyratings = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_colcandidates.Get((Object)("safetyRatings"))));
 //BA.debugLineNum = 469;BA.debugLine="Dim colsafetyRatings As Map";
_colsafetyratings = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 470;BA.debugLine="colsafetyRatings.Initialize";
_colsafetyratings.Initialize();
 //BA.debugLineNum = 471;BA.debugLine="For Each colsafetyRatings As Map In safetyRatin";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 472;BA.debugLine="Dim probability As String = colsafetyRatings.G";
_probability = BA.ObjectToString(_colsafetyratings.Get((Object)("probability")));
 //BA.debugLineNum = 473;BA.debugLine="Dim category As String = colsafetyRatings.Get(";
...
this.state = 11;
;
 //BA.debugLineNum = 475;BA.debugLine="Dim content As Map";
_content = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 476;BA.debugLine="content.Initialize";
_content.Initialize();
 //BA.debugLineNum = 477;BA.debugLine="content = colcandidates.Get(\"content\")";
_content = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_colcandidates.Get((Object)("content"))));
 //BA.debugLineNum = 478;BA.debugLine="Dim role As String = content.Get(\"role\")";
_role = BA.ObjectToString(_content.Get((Object)("role")));
 //BA.debugLineNum = 479;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
...
_parts = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_content.Get((Object)("parts"))));
 //BA.debugLineNum = 481;BA.debugLine="partes=parts";
parent._partes = _parts;
 //BA.debugLineNum = 482;BA.debugLine="Dim colparts As Map";
_colparts = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 483;BA.debugLine="colparts.Initialize";
_colparts.Initialize();
 //BA.debugLineNum = 484;BA.debugLine="For Each colparts As Map In parts";
if (true) break;
...
//C
this.state = 25;
 //BA.debugLineNum = 485;BA.debugLine="Dim text As String = colparts.Get(\"text\")";
...
this.state = 18;
;
 //BA.debugLineNum = 490;BA.debugLine="Dim usageMetadata As Map";
_usagemetadata = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 491;BA.debugLine="usageMetadata.Initialize";
_usagemetadata.Initialize();
 //BA.debugLineNum = 492;BA.debugLine="usageMetadata = jRoot.Get(\"usageMetadata\")";
_usagemetadata = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("usageMetadata"))));
 //BA.debugLineNum = 493;BA.debugLine="Dim candidatesTokenCount As Int = usageMetadata.";
_candidatestokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("candidatesTokenCount"))));
 //BA.debugLineNum = 494;BA.debugLine="Dim totalTokenCount As Int = usageMetadata.Get(\"";
_totaltokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("totalTokenCount"))));
 //BA.debugLineNum = 495;BA.debugLine="Dim promptTokenCount As Int = usageMetadata.Get(";
...
//C
this.state = 18;
 //BA.debugLineNum = 501;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 502;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 503;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 504;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 505;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 506;BA.debugLine="Dim error As Map";
_error = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 507;BA.debugLine="error.Initialize";
_error.Initialize();
 //BA.debugLineNum = 508;BA.debugLine="error = jRoot.Get(\"error\")";
_error = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("error"))));
 //BA.debugLineNum = 509;BA.debugLine="Dim code As Int = error.Get(\"code\")";
_code = (int)(BA.ObjectToNumber(_error.Get((Object)("code"))));
 //BA.debugLineNum = 510;BA.debugLine="Dim message As String = error.Get(\"message\")";
_message = BA.ObjectToString(_error.Get((Object)("message")));
 //BA.debugLineNum = 511;BA.debugLine="Dim status As String = error.Get(\"status\")";
parent._status = BA.ObjectToString(_error.Get((Object)("status")));
 //BA.debugLineNum = 512;BA.debugLine="Log(message)";
parent.__c.LogImpl("21638509",_message,0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 515;BA.debugLine="j.Release";
_j._release /*String*/ ();
 //BA.debugLineNum = 517;BA.debugLine="Log(partes)";
parent.__c.LogImpl("21638514",BA.ObjectToString(parent._partes),0);
 //BA.debugLineNum = 520;BA.debugLine="ProcessList(partes)";
...
public ResumableSub_enviarAINombre(b4j.smartscan.sv parent,String _message) {
this.parent = parent;
this._message = _message;
}
b4j.smartscan.sv parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 528;BA.debugLine="Dim strAPIurl As String =\"https://generativelangu";
_strapiurl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAAlU6UEaSo0NcGFZWC_q2uZOh8uBuQSt0";
 //BA.debugLineNum = 529;BA.debugLine="Log(strAPIurl)";
parent.__c.LogImpl("21703938",_strapiurl,0);
 //BA.debugLineNum = 532;BA.debugLine="Dim partsMap As Map";
_partsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 533;BA.debugLine="partsMap.Initialize";
_partsmap.Initialize();
 //BA.debugLineNum = 534;BA.debugLine="partsMap.Put(\"text\", $\" del siguiente bloque de t";
_partsmap.Put((Object)("text"),(Object)((" del siguiente bloque de texto necesito que me identifiques y ordenes los siguientes valores Nombre y Numero de identificacion  el nombre puedes encontrarlo\n"+"	como uno o dos nombre como ejemplo JUAN MANUEL por favor concatena con el apellido que puedes encontrarlo como ejemplo como LOPEZ GONZALEZ limita la respuesta unicamente a los datos\n"+"	en una lista ordenada  en el formato Nombre: JUAN MANUEL LOPEZ GONZALEZ\\Identidad: 0801199012345\\n\n"+"	recuerda unicamente Nombre concatenado con el apellido y Numero de identidad no mas datos.: "+parent.__c.SmartStringFormatter("",(Object)(_message))+" ")));
 //BA.debugLineNum = 540;BA.debugLine="Dim partsList As List";
_partslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 541;BA.debugLine="partsList.Initialize";
_partslist.Initialize();
 //BA.debugLineNum = 542;BA.debugLine="partsList.Add(partsMap)";
_partslist.Add((Object)(_partsmap.getObject()));
 //BA.debugLineNum = 545;BA.debugLine="Dim contentsMap As Map";
_contentsmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 546;BA.debugLine="contentsMap.Initialize";
_contentsmap.Initialize();
 //BA.debugLineNum = 547;BA.debugLine="contentsMap.Put(\"parts\", partsList)";
_contentsmap.Put((Object)("parts"),(Object)(_partslist.getObject()));
 //BA.debugLineNum = 550;BA.debugLine="Dim contentsList As List";
_contentslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 551;BA.debugLine="contentsList.Initialize";
_contentslist.Initialize();
 //BA.debugLineNum = 552;BA.debugLine="contentsList.Add(contentsMap)";
_contentslist.Add((Object)(_contentsmap.getObject()));
 //BA.debugLineNum = 555;BA.debugLine="Dim finalMap As Map";
_finalmap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 556;BA.debugLine="finalMap.Initialize";
_finalmap.Initialize();
 //BA.debugLineNum = 557;BA.debugLine="finalMap.Put(\"contents\", contentsList)";
_finalmap.Put((Object)("contents"),(Object)(_contentslist.getObject()));
 //BA.debugLineNum = 560;BA.debugLine="Dim JSONGenerator As JSONGenerator";
_jsongenerator = new anywheresoftware.b4j.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 561;BA.debugLine="JSONGenerator.Initialize(finalMap)";
_jsongenerator.Initialize(_finalmap);
 //BA.debugLineNum = 563;BA.debugLine="Log(JSONGenerator.ToString)";
parent.__c.LogImpl("21703972",_jsongenerator.ToString(),0);
 //BA.debugLineNum = 565;BA.debugLine="Dim strPayload As String = JSONGenerator.ToString";
_strpayload = _jsongenerator.ToString();
 //BA.debugLineNum = 567;BA.debugLine="Dim j As HttpJob";
_j = new b4j.smartscan.httpjob();
 //BA.debugLineNum = 568;BA.debugLine="j.Initialize(\"\", Me)";
_j._initialize /*String*/ (ba,"",parent);
 //BA.debugLineNum = 569;BA.debugLine="J.PostString(strAPIurl,strPayload)";
_j._poststring /*String*/ (_strapiurl,_strpayload);
 //BA.debugLineNum = 570;BA.debugLine="J.GetRequest.SetContentType(\"application/json\")";
_j._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 572;BA.debugLine="Wait For (J) JobDone(j As HttpJob)";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_j));
this.state = 19;
return;
case 19:
...
_j = (b4j.smartscan.httpjob) result[0];
;
 //BA.debugLineNum = 573;BA.debugLine="If J.Success Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 575;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 576;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 577;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 578;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 579;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 580;BA.debugLine="Dim candidates As List";
_candidates = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 581;BA.debugLine="candidates.Initialize";
_candidates.Initialize();
 //BA.debugLineNum = 582;BA.debugLine="candidates= jRoot.Get(\"candidates\")";
_candidates = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jroot.Get((Object)("candidates"))));
 //BA.debugLineNum = 583;BA.debugLine="Dim colcandidates As Map";
_colcandidates = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 584;BA.debugLine="colcandidates.Initialize";
_colcandidates.Initialize();
 //BA.debugLineNum = 585;BA.debugLine="For Each colcandidates As Map In candidates";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 586;BA.debugLine="Dim finishReason As String = colcandidates.Get(";
_finishreason = BA.ObjectToString(_colcandidates.Get((Object)("finishReason")));
 //BA.debugLineNum = 587;BA.debugLine="Dim index As Int = colcandidates.Get(\"index\")";
_index = (int)(BA.ObjectToNumber(_colcandidates.Get((Object)("index"))));
 //BA.debugLineNum = 588;BA.debugLine="Dim safetyRatings As List";
_safetyratings = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 589;BA.debugLine="safetyRatings.Initialize";
_safetyratings.Initialize();
 //BA.debugLineNum = 590;BA.debugLine="safetyRatings = colcandidates.Get(\"safetyRating";
_safetyratings = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_colcandidates.Get((Object)("safetyRatings"))));
 //BA.debugLineNum = 591;BA.debugLine="Dim colsafetyRatings As Map";
_colsafetyratings = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 592;BA.debugLine="colsafetyRatings.Initialize";
_colsafetyratings.Initialize();
 //BA.debugLineNum = 593;BA.debugLine="For Each colsafetyRatings As Map In safetyRatin";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 594;BA.debugLine="Dim probability As String = colsafetyRatings.G";
_probability = BA.ObjectToString(_colsafetyratings.Get((Object)("probability")));
 //BA.debugLineNum = 595;BA.debugLine="Dim category As String = colsafetyRatings.Get(";
_category = BA.ObjectToString(_colsafetyratings.Get((Object)("category")));
 if (true) break;
if (true) break;
...
this.state = 11;
;
 //BA.debugLineNum = 597;BA.debugLine="Dim content As Map";
_content = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 598;BA.debugLine="content.Initialize";
_content.Initialize();
 //BA.debugLineNum = 599;BA.debugLine="content = colcandidates.Get(\"content\")";
_content = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_colcandidates.Get((Object)("content"))));
 //BA.debugLineNum = 600;BA.debugLine="Dim role As String = content.Get(\"role\")";
_role = BA.ObjectToString(_content.Get((Object)("role")));
 //BA.debugLineNum = 601;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
_parts = new anywheresoftware.b4a.objects.collections.List();
_parts = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_content.Get((Object)("parts"))));
 //BA.debugLineNum = 603;BA.debugLine="partes=parts";
parent._partes = _parts;
 //BA.debugLineNum = 604;BA.debugLine="Dim colparts As Map";
_colparts = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 605;BA.debugLine="colparts.Initialize";
_colparts.Initialize();
 //BA.debugLineNum = 606;BA.debugLine="For Each colparts As Map In parts";
if (true) break;
...
//C
this.state = 25;
 //BA.debugLineNum = 607;BA.debugLine="Dim text As String = colparts.Get(\"text\")";
_text = BA.ObjectToString(_colparts.Get((Object)("text")));
 if (true) break;
if (true) break;
...
this.state = 18;
;
 //BA.debugLineNum = 612;BA.debugLine="Dim usageMetadata As Map";
_usagemetadata = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 613;BA.debugLine="usageMetadata.Initialize";
_usagemetadata.Initialize();
 //BA.debugLineNum = 614;BA.debugLine="usageMetadata = jRoot.Get(\"usageMetadata\")";
_usagemetadata = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("usageMetadata"))));
 //BA.debugLineNum = 615;BA.debugLine="Dim candidatesTokenCount As Int = usageMetadata.";
_candidatestokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("candidatesTokenCount"))));
 //BA.debugLineNum = 616;BA.debugLine="Dim totalTokenCount As Int = usageMetadata.Get(\"";
_totaltokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("totalTokenCount"))));
 //BA.debugLineNum = 617;BA.debugLine="Dim promptTokenCount As Int = usageMetadata.Get(";
_prompttokencount = (int)(BA.ObjectToNumber(_usagemetadata.Get((Object)("promptTokenCount"))));
 if (true) break;
...
//C
this.state = 18;
 //BA.debugLineNum = 623;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4j.objects.collections.JSONParser();
 //BA.debugLineNum = 624;BA.debugLine="parser.Initialize(J.GetString)";
_parser.Initialize(_j._getstring /*String*/ ());
 //BA.debugLineNum = 625;BA.debugLine="Dim jRoot As Map";
_jroot = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 626;BA.debugLine="jRoot.Initialize";
_jroot.Initialize();
 //BA.debugLineNum = 627;BA.debugLine="jRoot = parser.NextObject";
_jroot = _parser.NextObject();
 //BA.debugLineNum = 628;BA.debugLine="Dim error As Map";
_error = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 629;BA.debugLine="error.Initialize";
_error.Initialize();
 //BA.debugLineNum = 630;BA.debugLine="error = jRoot.Get(\"error\")";
_error = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_jroot.Get((Object)("error"))));
 //BA.debugLineNum = 631;BA.debugLine="Dim code As Int = error.Get(\"code\")";
_code = (int)(BA.ObjectToNumber(_error.Get((Object)("code"))));
 //BA.debugLineNum = 632;BA.debugLine="Dim message As String = error.Get(\"message\")";
_message = BA.ObjectToString(_error.Get((Object)("message")));
 //BA.debugLineNum = 633;BA.debugLine="Dim status As String = error.Get(\"status\")";
parent._status = BA.ObjectToString(_error.Get((Object)("status")));
 //BA.debugLineNum = 634;BA.debugLine="Log(message)";
parent.__c.LogImpl("21704043",_message,0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 637;BA.debugLine="j.Release";
_j._release /*String*/ ();
 //BA.debugLineNum = 639;BA.debugLine="Log(partes)";
parent.__c.LogImpl("21704048",BA.ObjectToString(parent._partes),0);
 //BA.debugLineNum = 641;BA.debugLine="ProcessListNombre(partes)";
...
_mysql.ExecNonQuery2("insert into InfoDB values (?,?,?,?,?,?,?,?,?,?) ",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{__c.Null,_txtnombre.GetVal().getValue(),_txtidentidad.GetVal().getValue(),__c.Null,_txtmotor.GetVal().getValue(),_txtplaca.GetVal().getValue(),_txtanio.GetVal().getValue(),_txtcolor.GetVal().getValue(),_txtchasis.GetVal().getValue(),(Object)("SV")}));
...
_main._sql1 /*anywheresoftware.b4j.objects.SQL*/ .InitializeSQLite(__c.File.getDirApp()+"/DB","InfoDBSV.db",__c.False);
...
__c.LogImpl("21114114",BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagesv"))),0);
 //BA.debugLineNum = 277;BA.debugLine="Log(txtiddelmovil.GetVal.Value)";
__c.LogImpl("21114115",BA.ObjectToString(_txtiddelmovil.GetVal().getValue()),0);
 //BA.debugLineNum = 278;BA.debugLine="txtmensaje.SetHtml(\"\")";
_txtmensaje.SetHtml("");
 //BA.debugLineNum = 279;BA.debugLine="Log(\"CLICK\")";
__c.LogImpl("21114117","CLICK",0);
 //BA.debugLineNum = 281;BA.debugLine="txtmensaje.SetText(Main.msj.Get(txtiddelmovil.Get";
_txtmensaje.SetText(BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagesv"))));
 //BA.debugLineNum = 284;BA.debugLine="Dim message As String = Main.msj.Get(txtiddelmovi";
_message = BA.ObjectToString(_main._msj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(BA.ObjectToString(_txtiddelmovil.GetVal().getValue())+"messagesv")));
 //BA.debugLineNum = 286;BA.debugLine="If message.Contains(\"MOTOR\") Or message.Contains(";
if (_message.contains("MOTOR") || _message.contains("MODELO") || _message.contains("COLOR") || _message.contains("CHASIS")) { 
...
if (_message.contains("Nombre") || _message.contains("Identidad") || _message.contains("ID number") || _message.contains("Surname")) { 
...
__c.LogImpl("2524289","click al boton leertesseract",0);
...
__c.LogImpl("2524298",BA.ObjectToString(_langlist),0);
 //BA.debugLineNum = 81;BA.debugLine="Log(langmap)";
__c.LogImpl("2524299",BA.ObjectToString(_langmap),0);
 //BA.debugLineNum = 82;BA.debugLine="Log(langmap.Get(\"Español\"))";
__c.LogImpl("2524300",BA.ObjectToString(_langmap.Get((Object)("Español"))),0);
...
__c.LogImpl("21376257",_text,0);
 //BA.debugLineNum = 352;BA.debugLine="Log(ProcessingTime & \" ms\")";
__c.LogImpl("21376258",BA.NumberToString(_processingtime)+" ms",0);
...
__c.LogImpl("21441793",BA.ObjectToString(_overlay),0);
...
__c.LogImpl("2589836",_main._nombrearchivo /*String*/ ,0);
...
__c.LogImpl("2589853",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
...
_motor = _extractvalue(_text,"Motor:","VIN:");
 //BA.debugLineNum = 302;BA.debugLine="Dim placa As String = ExtractValue(text, \"VIN:\",";
_placa = _extractvalue(_text,"VIN:","Año:");
...
String _nombre = "";
String _identidad = "";
 //BA.debugLineNum = 646;BA.debugLine="Sub ProcessListNombre(inputList As List)";
 //BA.debugLineNum = 647;BA.debugLine="For Each item As Map In inputList";
_item = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group1 = _inputlist;
final int groupLen1 = group1.getSize()
...
for (; index1 < groupLen1;index1++){
_item = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group1.Get(index1)));
 //BA.debugLineNum = 648;BA.debugLine="Dim text As String = item.Get(\"text\")";
_text = BA.ObjectToString(_item.Get((Object)("text")));
 //BA.debugLineNum = 651;BA.debugLine="Dim nombre As String = ExtractValue(text, \"Nombr";
_nombre = _extractvalue(_text,"Nombre:","\\Identidad:");
 //BA.debugLineNum = 652;BA.debugLine="Dim identidad As String = ExtractValue(text, \"Id";
_identidad = _extractvalue(_text,"Identidad:","\\n");
 //BA.debugLineNum = 654;BA.debugLine="Log(nombre)";
__c.LogImpl("21769480",_nombre,0);
 //BA.debugLineNum = 656;BA.debugLine="txtnombre.SetVal(nombre)";
_txtnombre.SetVal((Object)(_nombre));
 //BA.debugLineNum = 657;BA.debugLine="txtidentidad.SetVal(identidad)";
_txtidentidad.SetVal((Object)(_identidad));
 }
};
 //BA.debugLineNum = 660;BA.debugLine="ws.Eval(\"validarCampos()\",Null)";
_ws.Eval("validarCampos()",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
...
__c.LogImpl("2655368","iniciado",0);
 }else {
...
__c.LogImpl("2655371",__c.File.Combine(__c.File.Combine(__c.File.getDirApp(),"tesseract-ocr"),"tesseract"),0);
 };
...
__c.LogImpl("21572866","Success",0);
 //BA.debugLineNum = 375;BA.debugLine="Log(StdOut)";
__c.LogImpl("21572867",_stdout,0);
...
__c.LogImpl("21572872",_message,0);
 //BA.debugLineNum = 384;BA.debugLine="If message.Contains(\"Nombre\") Or message.Contain";
if (_message.contains("Nombre") || _message.contains("Identidad") || _message.contains("ID number") || _message.contains("Surname")) { 
 //BA.debugLineNum = 385;BA.debugLine="enviarAINombre(message)";
_enviarainombre(_message);
 };
 //BA.debugLineNum = 388;BA.debugLine="If message.Contains(\"MOTOR\") Or message.Contains";
if (_message.contains("MOTOR") || _message.contains("MODELO") || _message.contains("COLOR") || _message.contains("CHASIS")) { 
 //BA.debugLineNum = 389;BA.debugLine="enviarAI(message)";
_enviarai(_message);
 };
 }else {
 //BA.debugLineNum = 394;BA.debugLine="Log(ExitCode)";
__c.LogImpl("21572886",BA.NumberToString(_exitcode),0);
 //BA.debugLineNum = 395;BA.debugLine="Log(\"Error: \" & StdErr)";
__c.LogImpl("21572887","Error: "+_stderr,0);
...
__c.LogImpl("2327689",_ws.getSession().getId(),0);
...
__c.LogImpl("2851971","disconnected",0);
