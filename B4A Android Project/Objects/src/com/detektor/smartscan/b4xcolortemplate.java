package com.detektor.smartscan;
...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.detektor.smartscan.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.detektor.smartscan.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public com.detektor.smartscan.b4xcolortemplate._colorpickerpart _huebar = null;
public com.detektor.smartscan.b4xcolortemplate._colorpickerpart _colorpicker = null;
public com.detektor.smartscan.b4xcolortemplate._colorpickerpart _alphabar = null;
public int _borderscolor = 0;
public com.detektor.smartscan.b4xdialog _xdialog = null;
public Object[] _initialcolor = null;
public b4a.example.dateutils _dateutils = null;
public com.detektor.smartscan.main _main = null;
public com.detektor.smartscan.starter _starter = null;
public com.detektor.smartscan.xuiviewsutils _xuiviewsutils = null;
...
int _r = 0;
int _w = 0;
com.detektor.smartscan.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_cpp = (com.detektor.smartscan.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_huebar = new com.detektor.smartscan.b4xcolortemplate._colorpickerpart();
_colorpicker = new com.detektor.smartscan.b4xcolortemplate._colorpickerpart();
_alphabar = new com.detektor.smartscan.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 12;BA.debugLine="Private BordersColor As Int";
_borderscolor = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new com.detektor.smartscan.b4xdialog();
...
public com.detektor.smartscan.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
com.detektor.smartscan.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new com.detektor.smartscan.b4xcolortemplate._colorpickerpart();
...
public String  _drawcheckers(com.detektor.smartscan.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(com.detektor.smartscan.b4xdialog _dialog) throws Exception{
...
public void  _show(com.detektor.smartscan.b4xdialog _dialog) throws Exception{
ResumableSub_Show rsub = new ResumableSub_Show(this,_dialog);
rsub.resume(ba, null);
}
public static class ResumableSub_Show extends BA.ResumableSub {
public ResumableSub_Show(com.detektor.smartscan.b4xcolortemplate parent,com.detektor.smartscan.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.detektor.smartscan.b4xcolortemplate parent;
com.detektor.smartscan.b4xdialog _dialog;
...
if (BA.fastSubCompare(sub, "GETPANEL"))
	return _getpanel((com.detektor.smartscan.b4xdialog) args[0]);
