...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.detektor.smartscan.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.detektor.smartscan.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public com.detektor.smartscan.b4xdialog _mdialog = null;
...
_mdialog = new com.detektor.smartscan.b4xdialog();
...
public ResumableSub_Show(com.detektor.smartscan.b4xdatetemplate parent,com.detektor.smartscan.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.detektor.smartscan.b4xdatetemplate parent;
