...
public class websockethandler extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.detektor.smartscan.websockethandler");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.detektor.smartscan.websockethandler.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("41572876","TextMessage Error: "+BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
