...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.detektor.smartscan", "com.detektor.smartscan.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.detektor.smartscan", "com.detektor.smartscan.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.detektor.smartscan.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static com.detektor.smartscan.websockethandler _wsh = null;
...
public com.detektor.smartscan.b4xcombobox _b4xcombobox1 = null;
...
public ResumableSub_Button1_Click(com.detektor.smartscan.main parent) {
this.parent = parent;
}
com.detektor.smartscan.main parent;
...
mostCurrent._b4xcombobox1 = new com.detektor.smartscan.b4xcombobox();
...
_wsh = new com.detektor.smartscan.websockethandler();
