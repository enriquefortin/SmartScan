...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.detektor.smartscandtk.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.detektor.smartscandtk.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public com.detektor.smartscandtk.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new com.detektor.smartscandtk.b4xfloattextfield();
...
public com.detektor.smartscandtk.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((com.detektor.smartscandtk.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(com.detektor.smartscandtk.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((com.detektor.smartscandtk.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (com.detektor.smartscandtk.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(com.detektor.smartscandtk.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
com.detektor.smartscandtk.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((com.detektor.smartscandtk.b4xfloattextfield)(this)) == false) { 
